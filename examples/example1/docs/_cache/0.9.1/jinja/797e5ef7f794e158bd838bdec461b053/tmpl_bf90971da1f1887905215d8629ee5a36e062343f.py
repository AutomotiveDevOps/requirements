...
def block_head_css(context, missing=missing):
    ...
    yield escape(context.call(environment.getattr((undefined(name='view_object') if l_0_view_object is missing else l_0_view_object), 'render_static_url'), 'project_coverage.css', _block_vars=_block_vars))
    yield '"/>\n'
...
def block_head_scripts(context, missing=missing):
    ...
    yield escape(context.call(l_0_super, _block_vars=_block_vars))
    yield '\n  <script src="'
    yield escape(context.call(environment.getattr((undefined(name='view_object') if l_0_view_object is missing else l_0_view_object), 'render_static_url'), 'project_coverage.js', _block_vars=_block_vars))
    yield '"></script>\n'
