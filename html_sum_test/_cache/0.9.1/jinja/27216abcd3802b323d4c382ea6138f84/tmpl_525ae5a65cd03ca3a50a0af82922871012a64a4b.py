...
def root(context, missing=missing):
    ...
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_1((undefined(name='submit_url') if l_0_submit_url is missing else l_0_submit_url)), 'submit_url must be defined.', caller=caller)
    yield '\n'
    def macro():
        t_3 = []
        pass
        return concat(t_3)
    caller = Macro(environment, macro, None, (), False, False, False, context.eval_ctx.autoescape)
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_1((undefined(name='cancel_url') if l_0_cancel_url is missing else l_0_cancel_url)), 'cancel_url must be defined.', caller=caller)
    yield '\n'
    def macro():
        t_4 = []
        pass
        return concat(t_4)
    caller = Macro(environment, macro, None, (), False, False, False, context.eval_ctx.autoescape)
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_1((undefined(name='frame_id') if l_0_frame_id is missing else l_0_frame_id)), 'frame_id must be defined.', caller=caller)
    yield '\n\n<turbo-frame id="'
...
def block_form_content(context, missing=missing):
    ...
    def macro():
        ...
        return concat(t_5)
    caller = Macro(environment, macro, None, (), False, False, False, context.eval_ctx.autoescape)
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, 0, 'Must not reach here!', caller=caller, _block_vars=_block_vars)
    yield '\n    '
