...
def block_head_css(context, missing=missing):
    ...
    yield '"/>\n  <link rel="stylesheet" href="'
    yield escape(context.call(environment.getattr((undefined(name='view_object') if l_0_view_object is missing else l_0_view_object), 'render_static_url'), 'traceability_matrix.css', _block_vars=_block_vars))
    yield '"/>\n'
...
def block_head_scripts(context, missing=missing):
    ...
    yield '"></script>\n  <script src="'
    yield escape(context.call(environment.getattr((undefined(name='view_object') if l_0_view_object is missing else l_0_view_object), 'render_static_url'), 'requirements-coverage.js', _block_vars=_block_vars))
    yield '"></script>\n'
