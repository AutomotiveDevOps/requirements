...
def root(context, missing=missing):
    ...
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_1((undefined(name='requirement_change') if l_0_requirement_change is missing else l_0_requirement_change)), None, caller=caller)
