...
def root(context, missing=missing):
    ...
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_2((undefined(name='action_button_context') if l_0_action_button_context is missing else l_0_action_button_context)), None, caller=caller)
    def macro():
        t_5 = []
        pass
        return concat(t_5)
    caller = Macro(environment, macro, None, (), False, False, False, context.eval_ctx.autoescape)
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_2(environment.getattr((undefined(name='action_button_context') if l_0_action_button_context is missing else l_0_action_button_context), 'field_actions')), None, caller=caller)
    def macro():
        t_6 = []
        pass
        return concat(t_6)
    caller = Macro(environment, macro, None, (), False, False, False, context.eval_ctx.autoescape)
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_2(environment.getattr((undefined(name='action_button_context') if l_0_action_button_context is missing else l_0_action_button_context), 'field_name')), None, caller=caller)
    def macro():
        t_7 = []
        pass
        return concat(t_7)
    caller = Macro(environment, macro, None, (), False, False, False, context.eval_ctx.autoescape)
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_2(environment.getattr((undefined(name='action_button_context') if l_0_action_button_context is missing else l_0_action_button_context), 'mid')), 'mid is not defined', caller=caller)
    def macro():
        t_8 = []
        pass
        return concat(t_8)
    caller = Macro(environment, macro, None, (), False, False, False, context.eval_ctx.autoescape)
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_2(environment.getattr((undefined(name='action_button_context') if l_0_action_button_context is missing else l_0_action_button_context), 'testid_postfix')), 'testid_postfix is not defined', caller=caller)
