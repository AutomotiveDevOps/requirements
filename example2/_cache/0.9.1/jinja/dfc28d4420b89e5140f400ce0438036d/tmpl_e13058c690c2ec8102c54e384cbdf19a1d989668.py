...
def root(context, missing=missing):
    ...
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_2(environment.getattr((undefined(name='view_object') if l_0_view_object is missing else l_0_view_object), 'custom_html2pdf_template')), None, caller=caller)
    yield '\n\n<div\n  html2pdf-preloader\n  class="main"\n>\n      <div\n        html2pdf\n        class="content"\n      >'
