...
def block_head_css(context, missing=missing):
    ...
    yield escape(context.call(environment.getattr((undefined(name='view_object') if l_0_view_object is missing else l_0_view_object), 'render_static_url'), 'source.css', _block_vars=_block_vars))
    yield '" />\n  <link rel="stylesheet" href="'
...
def block_head_scripts(context, missing=missing):
    ...
    pass
    yield '\n  <script src="'
    yield escape(context.call(environment.getattr((undefined(name='view_object') if l_0_view_object is missing else l_0_view_object), 'render_static_url'), 'source-code-coverage.js', _block_vars=_block_vars))
    yield '"></script>\n  '
    yield escape(context.call(l_0_super, _block_vars=_block_vars))
    yield '\n'
