...
def root(context, missing=missing):
    ...
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, (t_1((undefined(name='requirement') if l_0_requirement is missing else l_0_requirement)) and (not t_2((undefined(name='requirement') if l_0_requirement is missing else l_0_requirement)))), None, caller=caller)
