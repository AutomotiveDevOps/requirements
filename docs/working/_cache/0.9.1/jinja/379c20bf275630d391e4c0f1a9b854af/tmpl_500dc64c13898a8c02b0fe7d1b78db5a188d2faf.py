...
def root(context, missing=missing):
    ...
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_1((undefined(name='relation_row_context') if l_0_relation_row_context is missing else l_0_relation_row_context)), 'row_with_relation: relation_row_context must be defined.', caller=caller)
    ...
    def macro():
        ...
        return concat(t_3)
    caller = Macro(environment, macro, None, (), False, False, False, context.eval_ctx.autoescape)
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_1(environment.getattr((undefined(name='relation_row_context') if l_0_relation_row_context is missing else l_0_relation_row_context), 'errors')), 'row_with_relation: errors must be defined.', caller=caller)
    if parent_template is None:
        yield '\n'
    def macro():
        t_4 = []
        ...
        return concat(t_4)
    caller = Macro(environment, macro, None, (), False, False, False, context.eval_ctx.autoescape)
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_1(environment.getattr((undefined(name='relation_row_context') if l_0_relation_row_context is missing else l_0_relation_row_context), 'field')), 'row_with_relation: field must be defined.', caller=caller)
    if parent_template is None:
        yield '\n'
    def macro():
        t_5 = []
        ...
        return concat(t_5)
    caller = Macro(environment, macro, None, (), False, False, False, context.eval_ctx.autoescape)
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_1(environment.getattr((undefined(name='relation_row_context') if l_0_relation_row_context is missing else l_0_relation_row_context), 'relation_types')), 'row_with_relation: relation_types must be defined.', caller=caller)
    if parent_template is None:
        yield '\n'
    def macro():
        t_6 = []
        ...
        return concat(t_6)
    caller = Macro(environment, macro, None, (), False, False, False, context.eval_ctx.autoescape)
    yield context.call(environment.extensions['strictdoc.export.html.html_templates.AssertExtension']._assert, t_1(environment.getattr((undefined(name='relation_row_context') if l_0_relation_row_context is missing else l_0_relation_row_context), 'form_object')), 'row_with_relation: form_object must be defined.', caller=caller)
    if parent_template is None:
        yield '\n\n'
